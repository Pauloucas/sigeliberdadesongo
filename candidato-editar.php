			  ...
			  <div class="col-sm-4">
				...
				País:
				  <select class="input sm form-control" name="pais" required="">
					  ...
					  <option value="Africa do sul">Outro</option>
          ...
          <div class="col-sm-12">
			...
			<div class="col-sm-12">
			  ...
			  <div class="col-sm-4">
				...
				<div class="col-sm-4">
				Numero de Telefone Activo:
				  <input type="text" maxlength="9" class="input-sm form-control" name="contactoEncarregado" value="<?php echo $resultado['contactoEncarregado']?>" placeholder="Ex: 841234560" >
				</div>
