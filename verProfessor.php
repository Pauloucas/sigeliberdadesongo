...
<div class="col col-lg-H col-md-H col-sm-H haggy">
    ...
    <div class="panel panel-default panel-table">
        <div class="panel-heading" >
			...
			<p>	
	            <div class="divH"><label>Dados do Professor</label></div>
	        </p> 
		</div>
          ...
          <div class="col-sm-12">
    		  ...
    		  <hr class="">
				...
				<div class="col-sm-6 col col-xs-6 text-right"> 
				  <a href='instrutor-editar.php?ID=<?php echo $ID; ?>'><button type='button' class='btn btn-warning'><span class="glyphicon glyphicon-edit"></span> Editar</button></a>
				</div>	
