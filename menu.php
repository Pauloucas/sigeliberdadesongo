      ...
      <div class="panel navbar with-nav-tabs navbar-fixed-top" >
        <div class="panel-heading" style="background-color: #3197ef;">
          <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse">
              ...
              <span class="icon-bar"></span>
                ...
                <a class="navbar-brand" href="inicio.php"><span style="color: #fff; font-size: 30px; "><label> S.G.E (ESCOLA PRIMARIA COMPLETA DA LIBERDADE - SONGO) </label></span></span></a>
          </div> 
          <div class="navbar-collapse collapse" id="navbar-collapse">
                ...
                ?>
    				      <li ><a href="mensagens.php"><span class="glyphicon glyphicon-envelope" style="color: #ffffff;font-size:18px;"> Entre em Contacto com a nossa Equipe</span></a></li>
                  <?php 
                      } 
...
?> ><span class="glyphicon glyphicon-bell"></span>
          ...
          <div class="alert alert-info">Sem notificação Ilustre</div><?php }
